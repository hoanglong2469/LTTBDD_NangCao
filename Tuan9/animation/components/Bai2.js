 ...
 const [location1, setLocation1] 
  ...
  return (
    <View
      ...
      <Animated.Image
       source = {icon}
       style={{marginLeft: marginLeft1, marginTop: marginTop1,maxWidth: '20%', resizeMode: "contain"}}
       >
      ...
      <Animated.Image
       source = {icon}
       style={{marginLeft: marginLeft2, marginTop: marginTop2,maxWidth: '20%', resizeMode: "contain"}}
       >
      ...
      <Animated.Image
       source = {icon}
       style={{marginLeft: marginLeft3, marginTop: marginTop3,maxWidth: '20%', resizeMode: "contain"}}
       >
